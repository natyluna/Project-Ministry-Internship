...
function Modificar($cone)
{
    ...
    try {
        $sql = "UPDATE personas SET dni ='$dni', nombre = '$nombre', apellido = '$apellido', fecha_nac = '$nacimiento', telefono = '$telefono', correo= '$email', nacionalidad = '$nacionalidad', sexo = '$sexo', latitud = '$latitud', longitud='$longitud' WHERE dni = '$dni'"; 
        $cone->exec($sql);
